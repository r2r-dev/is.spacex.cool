...
class PressurizedCapsule(object):
    ...
    def __init__(self, payload_volume=None, local_vars_configuration=None):  # noqa: E501
        """PressurizedCapsule - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._payload_volume = None
    ...
    def payload_volume(self):
        """Gets the payload_volume of this PressurizedCapsule.  # noqa: E501


        :return: The payload_volume of this PressurizedCapsule.  # noqa: E501
        :rtype: PayloadVolume
        """
        return self._payload_volume

    @payload_volume.setter
    def payload_volume(self, payload_volume):
        """Sets the payload_volume of this PressurizedCapsule.


        :param payload_volume: The payload_volume of this PressurizedCapsule.  # noqa: E501
        :type: PayloadVolume
        """


        self._payload_volume = payload_volume
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PressurizedCapsule):
            return False
