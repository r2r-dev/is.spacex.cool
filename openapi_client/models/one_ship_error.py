...
class OneShipError(object):
    ...
    def __init__(self, error=None, local_vars_configuration=None):  # noqa: E501
        """OneShipError - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this OneShipError.  # noqa: E501


        :return: The error of this OneShipError.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this OneShipError.


        :param error: The error of this OneShipError.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneShipError):
            return False
