...
from openapi_client.models.one_payload import OnePayload  # noqa: E501
from openapi_client.rest import ApiException

class TestOnePayload(unittest.TestCase):
    """OnePayload unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.one_payload.OnePayload()  # noqa: E501
        if include_optional :
            return OnePayload(
                payload_id = '0', 
                norad_id = [
                ...
                orbit = '0', 
                orbit_params = {"reference_system":"geocentric","regime":"geostationary","longitude":-108,"semi_major_axis_km":21226.178,"eccentricity":0.6904141,"periapsis_km":193.19,"apoapsis_km":29502.896,"inclination_deg":27.0648,"period_min":512.941,"lifespan_years":15,"epoch":"2018-08-07T06:57:16Z","mean_motion":2.80734018,"raan":227.0228}
            )
        else :
            return OnePayload(
                payload_id = '0',
