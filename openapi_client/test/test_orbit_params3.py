...
from openapi_client.models.orbit_params3 import OrbitParams3  # noqa: E501
from openapi_client.rest import ApiException

class TestOrbitParams3(unittest.TestCase):
    """OrbitParams3 unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.orbit_params3.OrbitParams3()  # noqa: E501
        if include_optional :
            return OrbitParams3(
                reference_system = '0', 
                regime = '0', 
                longitude = '0', 
                semi_major_axis_km = 1.337, 
                eccentricity = 1.337, 
                periapsis_km = 1.337, 
                apoapsis_km = 1.337, 
                inclination_deg = 1.337, 
                period_min = 1.337, 
                lifespan_years = 56, 
                epoch = '0', 
                mean_motion = 1.337, 
