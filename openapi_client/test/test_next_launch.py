...
from openapi_client.models.next_launch import NextLaunch  # noqa: E501
from openapi_client.rest import ApiException

class TestNextLaunch(unittest.TestCase):
    """NextLaunch unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.next_launch.NextLaunch()  # noqa: E501
        if include_optional :
            return NextLaunch(
                flight_number = 56, 
                mission_name = '0', 
                ...
                tbd = True, 
                launch_window = '0', 
                rocket = openapi_client.models.rocket4.Rocket4(
                    rocket_id = '0', 
                    rocket_name = '0', 
                    rocket_type = '0', 
                    first_stage = {"cores":[{"core_serial":"B1048","flight":3,"block":5,"gridfins":true,"legs":true,"reused":true,"land_success":null,"landing_intent":true,"landing_type":"ASDS","landing_vehicle":"OCISLY"}]}, 
                    second_stage = openapi_client.models.second_stage4.SecondStage4(
                        block = 56, 
                        payloads = [
                            {"payload_id":"Nusantara Satu (PSN-6)","norad_id":[],"reused":false,"customers":["Pasifik Satelit Nusantara"],"nationality":"Indonesia","manufacturer":"SSL","payload_type":"Satellite","payload_mass_kg":5000,"payload_mass_lbs":11023.11,"orbit":"GTO","orbit_params":{"reference_system":null,"regime":null,"longitude":null,"semi_major_axis_km":null,"eccentricity":null,"periapsis_km":null,"apoapsis_km":null,"inclination_deg":null,"period_min":null,"lifespan_years":15,"epoch":null,"mean_motion":null,"raan":null,"arg_of_pericenter":null,"mean_anomaly":null}}
                            ], ), 
                ...
                launch_success = '0', 
                links = {"mission_patch":null,"mission_patch_small":null,"reddit_campaign":"https://www.reddit.com/r/spacex/comments/afxyrd/nusantara_satu_launch_campaign_thread/","reddit_launch":null,"reddit_recovery":null,"reddit_media":null,"presskit":null,"article_link":null,"wikipedia":null,"video_link":null,"youtube_id":null,"flickr_images":[]}, 
                details = '0', 
                upcoming = True, 
