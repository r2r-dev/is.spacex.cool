...
from openapi_client.models.payload4 import Payload4  # noqa: E501
...
class TestPayload4(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.payload4.Payload4()  # noqa: E501
        if include_optional :
            return Payload4(
                payload_id = '0', 
                norad_id = [
                ...
                orbit = '0', 
                orbit_params = {"reference_system":null,"regime":null,"longitude":null,"semi_major_axis_km":null,"eccentricity":null,"periapsis_km":null,"apoapsis_km":null,"inclination_deg":null,"period_min":null,"lifespan_years":15,"epoch":null,"mean_motion":null,"raan":null,"arg_of_pericenter":null,"mean_anomaly":null}
            )
        else :
            return Payload4(
                payload_id = '0',
