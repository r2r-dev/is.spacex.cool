...
from openapi_client.models.timeline import Timeline  # noqa: E501
...
class TestTimeline(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.timeline.Timeline()  # noqa: E501
        if include_optional :
            return Timeline(
                webcast_liftoff = 56, 
                go_for_prop_loading = 56, 
                rp1_loading = 56, 
                stage1_lox_loading = 56, 
                stage2_lox_loading = 56, 
                engine_chill = 56, 
                prelaunch_checks = 56, 
                propellant_pressurization = 56, 
                go_for_launch = 56, 
                ignition = 56, 
                liftoff = 56, 
                maxq = 56, 
                meco = 56, 
                stage_sep = 56, 
                second_stage_ignition = 56, 
                seco_1 = 56, 
                dragon_separation = 56, 
                dragon_solar_deploy = 56, 
                dragon_bay_door_deploy = 56, 
                fairing_deploy = 56, 
                payload_deploy = 56, 
                second_stage_restart = 56, 
                seco_2 = 56, 
                webcast_launch = 56, 
                payload_deploy_1 = 56, 
                payload_deploy_2 = 56, 
                first_stage_boostback_burn = 56, 
                first_stage_entry_burn = 56, 
                first_stage_landing = 56, 
                beco = 56, 
                side_core_sep = 56, 
                side_core_boostback = 56, 
                center_stage_sep = 56, 
                center_core_boostback = 56, 
                side_core_entry_burn = 56, 
                center_core_entry_burn = 56, 
                side_core_landing = 56, 
                center_core_landing = 56
            )
        else :
            return Timeline(
        )
